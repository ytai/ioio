...
public class ShoebotActivity extends IOIOActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        enableButton_ = findViewById(R.id.enableButton);
        setButton_ = findViewById(R.id.setButton);
        driveButton_ = findViewById(R.id.driveButton);
        ...
        pTextView_ = findViewById(R.id.p);
        iTextView_ = findViewById(R.id.i);
        dTextView_ = findViewById(R.id.d);
        tTextView_ = findViewById(R.id.t);
        eTextView_ = findViewById(R.id.e);
        sTextView_ = findViewById(R.id.s);
