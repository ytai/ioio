...
public class IOIOManagerBTService extends Service {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				if (intent.getAction().equals(BTThread.ACTION_BT_CONNECTION)) {
					boolean connected = intent.getBooleanExtra(BTThread.EXTRA_CONNECTED, false);
					if (connected) {
						showNotification();
					} else {
						hideNotification();
			        ...
			        Toast.makeText(IOIOManagerBTService.this, R.string.got_image, Toast.LENGTH_LONG).show();
				}
			}
		};
    ...
    public void onCreate() {
        ...
        try {
        	...
        	BluetoothServerSocket server = adapter.listenUsingRfcommWithServiceRecord("IOIO Programmer", UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"));
    ...
    public void onStart(Intent intent, int startId) {
        Log.i("IOIOManagerBTService", "Received start id " + startId + ": " + intent);
    ...
    private void showNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getService(this, 0, stopIntent , 0);
