...
//	}
    ...
    throws ConnectionLostException, InvalidOperationException {
        return new IOIODigitalOutput(this, framerRegistry, spec, startValue);
    }
    ...
    throws ConnectionLostException, InvalidOperationException {
        return new IOIODigitalInput(this, framerRegistry, spec.pin, spec.mode);
    }
    ...
    @Override
    public PwmOutput openPwmOutput(DigitalOutputSpec spec, int freqHz) throws OutOfResourceException,
            ConnectionLostException, InvalidOperationException {
        return new IOIOPwmOutput(this, framerRegistry, spec, freqHz);
    }
